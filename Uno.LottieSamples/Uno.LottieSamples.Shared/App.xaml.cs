...
namespace LottieSamples
{
    ...
    sealed partial class App : Application
    {
        ...
        async Task RunAnimatedSplashScreenAsync()
        {
            ...
            var lottieSource = new LottieVisualSource {UriSource = new Uri("ms-appx:///Assets/LottieLogo1.json") };
            ...
            player.PlayAsync(fromProgress: 0, toProgress: 0.599, looped: false);
